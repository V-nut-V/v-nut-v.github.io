...
function loadLargeImage() {
  var mobileImage = document.getElementById("mobileimg");
  var pcImage = document.getElementById("pcimg");
  var title = document.getElementById("title");
  var imageList = document.querySelectorAll(".box img");
  var imageFileName = document.getElementById("img-file").textContent;
